...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tzStackView = PRStackView(arrangedSubviews: createViews())
        ...
        let controlsLayoutContainer = PRStackView(arrangedSubviews: [axisSegmentedControl, alignmentSegmentedControl, distributionSegmentedControl])
