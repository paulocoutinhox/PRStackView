...
class PRStackViewTests: PRStackViewTestCase {
...
//        views[4].hidden = true
    ...
    // Be careful to configure the same thing on the UIStackView as on the PRStackView, otherwise the test is unfair
    override func configureStackViews(_ uiStackView: UIStackView, _ tzStackView: PRStackView) {
